module.exports = {
    activation: function (token, email, hash){
        return "<div style='background: #615dfa;padding: 3em;width: 65%;margin: 0 auto;text-align: center;'>\n" +
            ...
            "        <a href='http://localhost:3000/verify?token="+ token +"&email="+ email +"&hash="+ hash +"' style='background: #615dfa;color: white;text-decoration: none;padding: 10px;border-radius: 10px;width: 50%;box-shadow: 1px 1px 5px 0px #00000040;margin: 2em auto;'>Επιβεβαίωση λογαριασμού</a>\n" +
            "    </div>\n" +
            "</div>";
    }
}